...
If Glob tool doesn't work, use PowerShell:
```powershell
Get-ChildItem -Path "[spec-path]/planning/visuals/" -File -Include *.png,*.jpg,*.jpeg,*.gif,*.svg,*.pdf -ErrorAction SilentlyContinue
```
