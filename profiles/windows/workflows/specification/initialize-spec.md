...
Determine a kebab-case spec name from the user's description, then create the spec folder using PowerShell:
...
New-Item -ItemType Directory -Force -Path "$SPEC_PATH/planning/visuals" | Out-Null

Write-Host "Created spec folder: $SPEC_PATH"
```
